"""Security log analyzer for a few common web and authentication signals."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Analyze a text log for simple security signals.")
